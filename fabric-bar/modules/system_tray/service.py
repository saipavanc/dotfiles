...
FABRIC_MODULE_PATH = os.path.dirname(fabric.__file__)
STATUS_NOTIFIER_WATCHER_BUS_IFACE_NODE = load_dbus_xml(
    FABRIC_MODULE_PATH + "/dbus_assets/org.kde.StatusNotifierWatcher.xml",
)

STATUS_NOTIFIER_ITEM_BUS_NAME = "org.kde.StatusNotifierItem"
STATUS_NOTIFIER_ITEM_BUS_IFACE_NODE = load_dbus_xml(
    FABRIC_MODULE_PATH + "/dbus_assets/org.kde.StatusNotifierItem.xml"
)
...
class SystemTrayItem(Service):
    ...
    def get_preferred_icon_pixbuf(
        ...
        # find the GTK.icon_theme for the theme name
