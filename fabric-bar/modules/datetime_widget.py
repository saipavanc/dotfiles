...
class DateTime(Button):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        button_press_connect_handle = self.connect(
            "button-press-event",
            lambda *args: self.do_handle_press(*args),  # to allow overriding
        )
        scroll_connect_handle = self.connect("scroll-event", lambda *args: self.do_handle_scroll(*args))
        self.connect_dict = {"button-press-event": button_press_connect_handle, "scroll-event": scroll_connect_handle}
