...
from hyprland.widgets import CaffeineButton
...
class SidePanel(Window):
    ...
    def __init__(self, **kwargs):
        ...
        self.hypridle_button = CaffeineButton()
        self.settings = Box(name="settings", children=[self.hypridle_button])
        ...
        self.add(
            Box(
                ...
                orientation="v",
                spacing=24,
                children=[self.header, self.greeter_label, self.settings],
            ),
        )
        self.show_all()
